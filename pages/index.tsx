            ...
            <main className="max-w-[640px] m-auto px-4 text-black">
              ...
              <div>
                ...
                <div className='font-medium mb-4'>
                  <p className="mb-3" id="index1">Everyday, we scan the web for you, collecting things you may need.</p>
                  <p className="mb-3" id="index2">Anytime you want, you can pop in to get something new to read, listen to, or watch.</p>
                  <p className="mb-3" id="index3">Sometimes you find a direct answer to a question. Sometimes you find new questions. And other times you find material you&apos;re able to build on in your current work.</p>
                  <p className="mb-3" id="index4">This website is made to provide you with the clues you need—whether you're exploring new areas of science, solving a health issue, or writing your next paper.</p>
                </div>
